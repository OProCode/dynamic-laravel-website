    ...
    <x-slot name="slot">
        ...
        <div class="flex flex-col gap-4 rounded-md w-full">
            ...
            <div class="flex flex-row w-full">
                <p class="p-2 w-1/6 bg-gray-600 rounded-l-md">{{__("RATING")}}</p>
                <p class="p-2 w-full">{{$rating->name}}</p>
            </div>
        ...
        <div class="flex flex-row w-full p-1">
            ...
            <p class="w-1/6 text-right">{{$rating->created_at}}</p>
        </div>

        <div class="flex flex-row w-full p-1">
            <p class="w-full text-right text-gray-200">UPDATED AT</p>
            <p class="w-1/6 text-right">{{$rating->updated_at}}</p>
        </div>
